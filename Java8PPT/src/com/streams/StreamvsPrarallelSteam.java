...
public class StreamvsPrarallelSteam {
	...
	public static void main(String[] args) {
		...
		Double avgSalary = emp.stream().mapToDouble(Employees::getSalary).average().getAsDouble();
...
//----------
		...
		System.out.println("plain Stream operation");
		start = System.currentTimeMillis();
		Double avgSalary1 = emp.parallelStream().mapToDouble(Employees::getSalary).average().getAsDouble();
		end = System.currentTimeMillis();
	
		System.out.println("parallel stream operation took " + (end - start) + "seconds and avg salary is" +avgSalary1 );
